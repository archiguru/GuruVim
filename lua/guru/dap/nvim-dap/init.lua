...
if dap and dapui and vt then
  ...
  if cfg.lua and cfg.lua.enable then
    require("guru.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("guru.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("guru.dap.nvim-dap.config.vscode-js")
  end

  require("guru.dap.nvim-dap.common-config").keyAttach()
end
