...
return function(config)
  return {
    ...
    getLSPConfigMap = function()
      local list = {
        tsserver = require("guru.lsp.config.typescript"),
        cssls = require("guru.lsp.config.css"),
        emmet_ls = require("guru.lsp.config.emmet"),
        html = require("guru.lsp.config.html"),
      }
      if config.tailwindcss then
        list.tailwindcss = require("guru.lsp.config.tailwindcss")
      end
      if config.vue then
        list.volar = require("guru.lsp.config.volar")
      end
      if config.prisma then
        list.prismals = require("guru.lsp.config.prismals")
      end
